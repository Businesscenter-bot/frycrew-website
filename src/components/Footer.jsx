      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-[#A67C2D]/30">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="pt-2">
              <span className="text-[11px] font-bold text-[#FEC72E] uppercase tracking-wider block mb-2">
                Folge der Crew auf Social Media:
              </span>
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-3 py-2 rounded-xl bg-[#283323] border border-[#A67C2D]/40 flex items-center gap-2 text-[#FEC72E] hover:bg-[#FEC72E] hover:text-[#222B1E] transition-all shadow group cursor-pointer"
                  aria-label="Instagram @fry_crew"
                >
                  ...
                  <span className="text-xs font-semibold">@fry_crew</span>
                </a>
