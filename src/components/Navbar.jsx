      ...
      <div className="bg-[#222B1E] border-b border-[#A67C2D]/30 text-[#F5F2E9] text-xs py-2 px-4">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-4 text-xs">
            ...
            <div className="hidden sm:flex items-center gap-2.5 border-l border-[#A67C2D]/30 pl-3">
              <a
                href={SOCIAL_LINKS.instagram}
                target="_blank"
                rel="noreferrer"
                className="text-[#F5F2E9]/80 hover:text-[#FEC72E] transition-colors p-0.5"
                aria-label="FryCrew auf Instagram"
                title="Instagram @fry_crew"
              >
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#F5F2E9]/80 hover:text-[#FEC72E] transition-colors p-0.5"
                aria-label="FryCrew auf Facebook"
                title="Facebook FryCrew"
              >
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-[#1D251A] border-t border-[#A67C2D]/30 px-4 pt-3 pb-6 space-y-3 shadow-2xl animate-in slide-in-from-top duration-200">
            ...
            <div className="pt-3 border-t border-[#A67C2D]/20 flex flex-col gap-2">
              ...
              <div className="flex items-center justify-center gap-4 pt-2 border-t border-[#A67C2D]/20">
                <a
                  href={SOCIAL_LINKS.instagram}
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1.5 text-xs text-[#FEC72E] hover:underline font-semibold"
                >
                ...
                <span className="text-[#F5F2E9]/30">·</span>
                <a
                  href={SOCIAL_LINKS.facebook}
                  target="_blank"
                  rel="noreferrer"
